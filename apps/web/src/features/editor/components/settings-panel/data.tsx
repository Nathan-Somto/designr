...

{
    ...
    options: ['Arial', 'Times New Roman', 'Courier New', 'Verdana', 'Comic Sans MS', 'Impact', 'Georgia', 'Trebuchet MS', 'Tahoma', 'Lucida Console', 'Brush Script MT', 'Palatino', 'Bookman', 'cursive'],
